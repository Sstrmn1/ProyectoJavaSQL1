...
CREATE TABLE `articulo` (
  ...
  `codigo` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `cliente` (
  ...
  `tipo_documento` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `numero_documento` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `direccion` (
  ...
  `calle` varchar(55) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `numero` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `oficina` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `activo` bit(1) NOT NULL DEFAULT b'1',
  PRIMARY KEY (`id_direccion`),
  UNIQUE KEY `iddireccion_UNIQUE` (`id_direccion`),
...
INSERT INTO `direccion` VALUES (1,1,1,'Calle A','123','Oficina 1',_binary ''),(2,2,2,'Avenida B','456','Oficina 2',_binary ''),(3,3,3,'Calle C','789','Oficina 3',_binary ''),(4,1,1,'Blanco galindo','150','-',_binary '');
...
CREATE TABLE `factura` (
  ...
  `codigo_autorizacion` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
INSERT INTO `factura` VALUES (1,1,'AUT001','2023-11-15 20:37:26',_binary ''),(2,2,'AUT002','2023-11-15 20:37:26',_binary ''),(3,3,'AUT003','2023-11-15 20:37:26',_binary '');
...
CREATE TABLE `forma_farmaceutica` (
  ...
  `descripcion` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `activo` bit(1) NOT NULL DEFAULT b'1',
...
CREATE TABLE `laboratorio` (
  ...
  `nombre` varchar(75) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `procedencia` varchar(75) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `activo` bit(1) NOT NULL DEFAULT b'1',
...
INSERT INTO `orden_de_venta` VALUES (1,1,2,'2023-11-15 20:37:26',3800.00),(2,2,2,'2023-11-15 20:37:26',3700.00),(3,3,2,'2023-11-15 20:37:26',3400.00);
...
INSERT INTO `rol` VALUES (1,'Administrador',_binary ''),(2,'Ventas',_binary ''),(3,'Regencia Farmaceutica',_binary ''),(4,'Almacenes',_binary '\0'),(5,'Secretaria',_binary '');
...
INSERT INTO `transaccion` VALUES (1,1,1,6000,'2023-11-15 20:37:26'),(2,2,1,2000,'2023-11-15 20:37:26'),(3,2,2,4000,'2023-11-15 20:37:26'),(4,3,2,7000,'2023-11-15 20:37:26'),(5,3,3,8000,'2023-11-15 20:37:26'),(6,4,3,5000,'2023-11-15 20:37:26');
...
CREATE TABLE `usuario` (
  ...
  `ci` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `fecha_nacimiento` date DEFAULT NULL,
  `foto` varchar(70) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `activo` bit(1) NOT NULL DEFAULT b'1',
...
-- Dump completed on 2023-11-20 16:17:29
